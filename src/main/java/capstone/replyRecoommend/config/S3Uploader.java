...
public class S3Uploader {
    ...
    public String upload(MultipartFile multipartFile, String dirName)  {
        ...
        try {
            uploadFile = convert(multipartFile).orElseThrow(() -> new BusinessException(CommonErrorCode.FILE_CHANGE_ERROR));
        } catch (IOException e) {
            throw new BusinessException(CommonErrorCode.FILE_CHANGE_ERROR);
        }
